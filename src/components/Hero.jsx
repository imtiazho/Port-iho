...
import heroImg from '../assets/dd.png';
...
export default function Hero({ setCursorState }) {
  ...
  return (
    <section 
      id="hero" 
      className="relative md:min-h-screen w-full bg-[#090909] text-[#D6C8B0] flex flex-col justify-center pt-12 pb-16 px-4 sm:px-8 lg:px-20 xl:px-24 overflow-hidden border-b border-[rgba(214,200,176,0.12)]"
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col justify-center my-auto pt-6">
        ...
        >
          <motion.h1
            ...
            className="hero-headline text-[8vw] md:text-[5rem] lg:text-[7.5rem] font-extrabold tracking-[-0.055em] leading-[0.88] uppercase break-normal whitespace-nowrap sm:whitespace-normal"
          >
            {/* Line 1: "I BUILD" (#D6C8B0) */}
            <div className="text-[#D6C8B0] hover:text-white transition-colors duration-200 mb-4 lg:mb-0">
              {hero.titleLine1}
            </div>
            {/* Line 2: "DIGITAL" (#FF5035) */}
            <div className="text-[#FF5035] hover:text-white transition-colors duration-200 mb-4 lg:mb-0">
              {hero.titleLine2}
            </div>
        ...
        <motion.div
          ...
          className="mt-5 sm:mt-10 max-w-3xl"
        >
          <p className="text-sm sm:text-md lg:text-xl text-[#D6C8B0]/95 font-normal leading-relaxed tracking-wide">
            {hero.description}
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-5 border-t border-[rgba(214,200,176,0.20)] border-dashed  sm:mt-8 pt-4 sm:pt-6 flex flex-wrap items-center gap-x-6 gap-y-3 text-xs sm:text-sm font-bold tracking-widest uppercase text-[#D6C8B0]"
        >
          <div className="flex items-center gap-2">
            <span className="text-[#FF5035] font-mono text-xs sm:text-base">01</span>
          ...
          <div className="flex items-center gap-2">
            <span className="text-[#FF5035] font-mono text-xs sm:text-base">02</span>
            <span className="hover:text-[#FF5035] transition-colors">FULL-STACK DEVELOPMENT</span>
          </div>
          <span className="text-[#8C8375]/40 hidden sm:inline">|</span>
          <div className="flex items-center gap-2">
            <span className="text-[#FF5035] font-mono text-xs sm:text-base">03</span>
